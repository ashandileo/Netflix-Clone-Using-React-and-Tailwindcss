...
const Contents = () => {
  return <>
    ...
    <Jumbotron>
      <Jumbotron.Pane className="flex flex-col items-center text-white text-center md:text-left md:items-start md:w-[52%] order-2">
        <Jumbotron.Title>Create profiles for kids.</Jumbotron.Title>
        <Jumbotron.SubTitle>Send kids on adventures with their favorite characters in a space made just for them—free with your membership.</Jumbotron.SubTitle>
      </Jumbotron.Pane>
      <Jumbotron.Pane className="w-full sm:w-[48%] order-1">
        <Jumbotron.Image src={profileKids} alt="Tv" />
      </Jumbotron.Pane>
    </Jumbotron> */}
  </>
}
